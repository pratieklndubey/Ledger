...
router.get('/:id/search', async (req, res) => {
  ...
  res.render('account/search/index', {option:"",title:account[0].name, account: account,relative:'../../',search:"",calculate:"",bell:"",searchRelative:'',god:"hanumanji"});
})
router.get('/:id/assets', async (req, res) => {
  ...
  searchOptions._id = req.params.id
  const account = await Account.find(searchOptions)
  res.render('account/assets/index', {title:account[0].name, account: account,month:month,year:year, option: "",calculate:"",search:"",bell:"",searchRelative:'',relative:'../../',priceGold:goldData,priceSilver:silverData,priceStocks:stockPrices,tickerStocks:stockTickers,god:"krishnaji"});
})
...
router.get('/:id/stats', async (req, res) => {
  ...
  month = new Date().getMonth()
    searchOptions._id = req.params.id
    const account = await Account.find(searchOptions)
    res.render('account/stats/index', {title:account[0].name, account: account,month:month,year:year, option: "",calculate:"",search:"",bell:"",searchRelative:'',relative:'../../',priceStocks:stockPrices,tickerStocks:stockTickers,priceGold:goldData,priceSilver:silverData,god:"laxmimata"});
  //res.send(account)
})
...
router.get('/:id/pivots', async (req, res) => {
  ...
  month = new Date().getMonth()
    searchOptions._id = req.params.id
    const account = await Account.find(searchOptions)
    res.render('account/pivots/index', {title:account[0].name, account: account,month:month,year:year, option: "",calculate:"",search:"",bell:"",searchRelative:'',relative:'../../',priceStocks:stockPrices,tickerStocks:stockTickers,priceGold:goldData,priceSilver:silverData,god:"saraswatimata"});
  //res.send(account)
})
...
router.get('/:id/chart', async (req, res) => {
  ...
  month = new Date().getMonth()
    searchOptions._id = req.params.id
    const account = await Account.find(searchOptions)
    res.render('account/chart/index', {title:account[0].name, account: account,month:month,year:year, option: "",calculate:"",search:"",bell:"",searchRelative:'',relative:'../../',priceStocks:stockPrices,tickerStocks:stockTickers,priceGold:goldData,priceSilver:silverData,god:"ganeshji"});
...
router.get('/:id/chart/:year/:month', async (req, res) => {
  ...
  let searchOptions = {}
    searchOptions._id = req.params.id
    const account = await Account.find(searchOptions)
    res.render('account/chart/index', {title:account[0].name, account: account,month:month,year:year, option: "",calculate:"",search:"",searchRelative:'',bell:"",relative:'../../../../',priceStocks:stockPrices,tickerStocks:stockTickers,priceGold:goldData,priceSilver:silverData,god:"ganeshji"});
  //res.send(account)
})
