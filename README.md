...
Installation Guide: <br/>
        1. Install [Python](https://www.python.org/downloads/)(Install necessary modules using pip), [Node-JS](https://nodejs.org/en/download/) and [MongoDB](https://www.mongodb.com/try/download/community)<br/>
